...
export const MOCK_BADGE_DEFINITIONS: BadgeDefinition[] = [
  {
    ...
    description: '100% attendance for a given month',
    icon: '🌟',
    category: 'attendance',
    isAutomatic: true,
    criteria: '{"type":"attendance","value":100}',
  },
  {
    id: 'bdg-def-2',
    title: 'Quiz Master',
  ...
  },
  {
    id: 'bdg-def-3',
    title: 'Homework Hero',
    description: 'Submit 5 consecutive assignments on time',
    icon: '📚',
    category: 'academic',
    isAutomatic: true,
    criteria: '{"type":"consecutive_homework","value":5}',
  },
  {
    id: 'bdg-def-4',
    title: 'Subject Scholar',
    description: 'Achieve top 10% grade in a specific subject term',
    icon: '🌟',
    category: 'academic',
    isAutomatic: true,
    criteria: '{"type":"top_percentile","value":10}',
  },
  {
    id: 'bdg-def-5',
    title: 'Consistent Performer',
    description: 'Never missed a homework deadline for an entire term',
    icon: '⏱️',
    category: 'academic',
    isAutomatic: true,
    criteria: '{"type":"term_consistency"}',
  },
  {
    id: 'bdg-def-6',
    title: 'Helping Hand',
    description: 'Awarded for assisting peers or teachers in class',
    icon: '🤝',
    category: 'behavior',
    isAutomatic: false,
  },
  {
    id: 'bdg-def-7',
    title: 'Most Improved',
    description: 'Showing significant academic or behavioral improvement',
    icon: '📈',
    category: 'behavior',
    isAutomatic: false,
  },
  {
    ...
    description: 'Taking a highly creative approach to an assignment',
    icon: '🎨',
    category: 'academic',
    isAutomatic: false,
  },
  {
    ...
    description: 'Excellence or victory in a school sports event',
    icon: '🏃',
  ...
  },
  {
    ...
    description: 'Active and positive participation in class discussions',
    icon: '🗣️',
    category: 'behavior',
    isAutomatic: false,
  },
...
export const MOCK_SUBMISSIONS: Submission[] = [
  {
    ...
    history: [
      ...
      {
        id: 'sub-aarav-math-v1',
        version: 1,
        submittedAt: '2026-07-28T10:15:00Z',
        fileUrl: 'Aarav_Math_Homework_Ch4_Draft.pdf',
        fileName: 'Aarav_Math_Homework_Ch4_Draft.pdf',
        responseText: 'Initial draft submission for teacher review.',
        status: 'graded',
        grade: 15,
        feedback: 'Good initial effort! Please resubmit with solutions for Q8 and Q9.',
        isLate: false,
      },
    ],
  },
