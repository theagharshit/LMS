  ...
  return (
    <div className="py-8 px-6 max-w-xl mx-auto space-y-6 text-slate-800 dark:text-slate-200">
      <div className="text-center space-y-2">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#EBF1E8] text-[#4A6741] font-extrabold text-[11px] uppercase tracking-wider">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-center space-y-1">
          <Clock className="w-5 h-5 mx-auto text-[#4A6741]" />
        ...
        <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-center space-y-1">
          <HelpCircle className="w-5 h-5 mx-auto text-[#E88D67]" />
        ...
        <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-center space-y-1">
          <Award className="w-5 h-5 mx-auto text-[#E88D67]" />
      ...
      {/* Instructions list */}
      <div className="p-4 rounded-2xl bg-[#EBF1E8]/50 border border-[#88A070]/40 space-y-2 text-xs">
        <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-1.5">
          <ShieldAlert className="w-4 h-4 text-[#4A6741]" />
      ...
      <button
        onClick={onStart}
        className="w-full py-3.5 rounded-2xl bg-[#E88D67] text-white font-extrabold text-sm hover:bg-[#D87B55] transition-all shadow-md shadow-[#E88D67]/20 flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-[#E88D67] focus:ring-offset-2"
      >
